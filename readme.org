...
Sessions persist across Emacs restarts via
[[https://github.com/timfel/agent-shell-desktop.el][agent-shell-desktop]] +
~desktop-save-mode~ (saves cwd, agent config, and session id). Enable
~agent-shell-desktop-mode~ before Desktop restores buffers.
...
(use-package agent-shell-desktop
  :ensure nil
  :quelpa (agent-shell-desktop :fetcher github
                               :repo "timfel/agent-shell-desktop.el")
  :after agent-shell
  :demand t
  :config
